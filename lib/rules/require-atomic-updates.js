...
class SegmentInfo {
    ...
    initialize(segment) {
        ...
        for (const prevSegment of segment.prevSegments) {
            ...
            if (info) {
                /* eslint-disable unicorn/no-array-method-this-argument -- Custom `this` */
                info.outdatedReadVariables.forEach(Set.prototype.add, outdatedReadVariables);
                info.freshReadVariables.forEach(Set.prototype.add, freshReadVariables);
                /* eslint-enable unicorn/no-array-method-this-argument -- Custom `this` */
            }
        }
    ...
    makeOutdated(segments) {
        for (const segment of segments) {
            ...
            if (info) {
                // eslint-disable-next-line unicorn/no-array-method-this-argument -- Custom `this`
