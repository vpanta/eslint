...
module.exports = {
    ...
    create(context) {
        ...
        function checkIndentInFunctionBlock(node) {
            ...
            indent = calleeNode.parent &&
                (calleeNode.parent.type === "Property" ||
                calleeNode.parent.type === "ArrayExpression") ? getNodeIndent(calleeNode, false).goodChar : getNodeIndent(calleeNode).goodChar;
        ...
        function expectedCaseIndent(node, providedSwitchIndent) {
            ...
            const caseIndent = switchNode.cases.length > 0 &&
