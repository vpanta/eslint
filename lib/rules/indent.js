...
class BinarySearchTree {
    ...
    insert(key, value) {
        ...
        this._rbTree = iterator.valid ? iterator.update(value) : this._rbTree.insert(key, value);
    }
    ...
    create(context) {
        ...
        function addFunctionCallIndent(node) {
            const openingParen = node.arguments.length
                ? sourceCode.getFirstTokenBetween(node.callee, node.arguments[0], astUtils.isOpeningParenToken)
