 ...
 * @property {string} [allowlistPath] The allowlist to use, if specified.
 */
...
function processOptions({
    ...
    rulePaths = [],
    useEslintrc = true,
    allowlistPath = null, // ← should be null by default because if it's a string then it may throw ENOENT.
    ...unknownOptions
}) {
    const errors = [];
    ...
    if (!isNonEmptyString(allowlistPath) && allowlistPath !== null) {
        errors.push("'allowlistPath' must be a non-empty string or null.");
    }
