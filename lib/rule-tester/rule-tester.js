...
class RuleTester {
    ...
    static get itOnly() {
        ...
        if (typeof it === "function") {
            throw new TypeError("The current test framework does not support exclusive tests with `only`.");
        }
        ...
        function runRuleForItem(item) {
            ...
            if (schema) {
                ...
                if (ajv.errors) {
                    ...
                    // eslint-disable-next-line unicorn/error-message -- Needs refactoring?
